...
tooLongSoHereItIsInASeperateFile = open("data stuff/frenchHens.txt")
    ...
    if copied[0][0][1] == copied[0][1][1] and copied[1][0][1] == copied[1][1][1]:
        if copied[0][0][1] == copied[0][1][1] == copied[1][0][1] == copied[1][1][1]:
            ...
            for x in setFirstRange.intersection(secondRange):
                goodPoints.append(
                    [x, copied[0][0][1]]
                )  # you could use any copied[][][] or something
        ...
        if (
            (copied[0][0][0] - copied[1][0][0]) * (copied[0][1][0] - copied[1][1][0])
            <= 0
            and (copied[0][0][1] - copied[1][0][1])
            * (copied[0][1][1] - copied[1][1][1])
            <= 0
        ):
